            ...
            <form id="addMediaReport" class="layui-form">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="whatTime" id="time" lay-verify="required" placeholder="yyyy-MM-dd HH:mm:ss" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item" style="margin-top: 20px;">
                    <div class="layui-input-block">
...
<script>
    layui.use(['form', 'laytpl', 'layedit', 'upload','laydate'], function () {
        ...
        form.on('submit(fabu)', function (data) {
            ...
            $.post('<%=path %>/data/dynamic/addDynamic',
